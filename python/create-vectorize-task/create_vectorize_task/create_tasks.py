...
def main():
    ...
    parser.add_argument('--max-task-batch', type=int, required=True)
    ...
    if task_count > args.skip_tasks + args.max_task_batch:
        task_count = args.skip_tasks + args.max_task_batch
